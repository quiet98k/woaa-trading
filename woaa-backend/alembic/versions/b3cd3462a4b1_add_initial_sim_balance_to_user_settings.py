"""Add initial_sim_balance to user_settings

Revision ID: b3cd3462a4b1
Revises: 2aa85d6fa51d
Create Date: 2025-07-01 00:40:16.003412
...
revision: str = 'b3cd3462a4b1'
down_revision: Union[str, Sequence[str], None] = '2aa85d6fa51d'
...
def downgrade() -> None:
    ...
    sa.Column('margin_limit', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    ...
    sa.Column('sim_time', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    ...
    sa.Column('borrowed_margin', sa.DOUBLE_PRECISION(precision=53), server_default=sa.text("'0'::double precision"), autoincrement=False, nullable=False),
